...
import com.s_h_y_a.kotlindatastore.pref.saveAsIntPref
import com.s_h_y_a.kotlindatastore.pref.saveAsStringFlowPref
import com.s_h_y_a.kotlindatastore.pref.saveAsStringPref

inline fun <reified E : Enum<E>, V> KotlinDataStoreModelWithScope<V>.enumNamePref(
    default: E,
    key: String? = null
) = saveAsStringPref(
    default,
...
inline fun <reified E : Enum<E>, V> KotlinDataStoreModelWithScope<V>.enumOrdinalPref(
    default: Enum<E>,
    key: String? = null
) = saveAsIntPref(
    default,
